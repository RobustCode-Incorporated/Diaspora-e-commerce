<template>
  <div class="register-container">
    ...
    <div class="left-panel">
      <img src="../assets/RobustCodelogowhite.png" alt="Logo Gouvernement RDC" class="logo" />
      <h1 class="title">Diaspora e-Commerces</h1>
    </div>

    <!-- Bloc droit -->
    <div class="right-panel">
      <h1 class="form-title">Créer un compte Administrateur Général</h1>
      <form class="register-form" @submit.prevent="handleRegister">
        ...
        <div class="form-group">
          ...
          <input type="tel" v-model="form.telephone" placeholder="+243 123 456 789" />
        </div>
...
onMounted(async () => {
  try {
    const res = await axios.get('http://localhost:4001/api/pays');
    pays.value = res.data;
  } catch (error) {
